...
$result = mysqli_query($conn, "SELECT * FROM rumpun");
...
<html lang="en">
    <head>
        ...
        <title>Tarombo Batak Toba - Rumpun</title>
    ...
    <body>
        ...
        <section class="page-section about-heading">
            <div class="container">
                <img class="img-fluid rounded about-heading-img mb-3 mb-lg-0" src="assets/img/download.jpg" width= "50%" alt="..." />
                <div class="about-heading-content">
                    <div class="row">
                        <div class="col-xl-9 col-lg-10 mx-auto">
                            <div class="bg-faded rounded p-5">
                            <h2 class="section-heading mb-4">
                                    <span class="section-heading-upper">Rumpun Marga Batak Toba</span>
                                </h2>
                                   <p>Rumpun Marga batak ialah Gomparan marga batak yang terdiri dari cabang-cabang marga batak toba
                                   </p>
                                   <p>Berikut rumpun marga batak toba :</p>
                                <style>
                                    table {
